...
const [first, setfirst] = useState("enable dark mode");
 ...
 const toggle = ()=>{
    if(mode.color === "black"){
        ...
        setfirst("enable light mode")
    }else {
        setMode({
            color : 'black' ,
            backgroundColor : 'white'
          })
        setfirst("enable dark mode")
  ...
  return (
    ...
    <h1>About Us</h1>
      <div className="accordion" id="accordionExample">
        ...
        <div className="accordion-item" style={mode}>
          ...
          <div
            ...
            data-bs-parent="#accordionExample" style={mode}
          >
            <div className="accordion-body" style={mode}>
      ...
      <div className="container my-3" >
        <button type="button" className="btn btn-dark" onClick={toggle}>{first}</button>
        </div>
      </>
  );
}
